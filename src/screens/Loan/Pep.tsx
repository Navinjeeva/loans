          ...
          >
            ...
            >
              ...
              <Switch
                ...
                thumbColor={pep?.isHeadOfState ? colors.primaryLight : "white"}
                onValueChange={(value) =>
                  updatePepData({
                    isHeadOfState: value,
                  })
            ...
            >
              ...
              <Switch
                trackColor={{ false: "#DADADA", true: colors.primary }}
                thumbColor={pep?.isHeadOfGovt ? colors.primaryLight : "white"}
                onValueChange={(value) =>
                  updatePepData({
                    isHeadOfGovt: value,
                  })
            ...
            >
              ...
              <Switch
                trackColor={{ false: "#DADADA", true: colors.primary }}
                thumbColor={
                  pep?.isSenPolitician ? colors.primaryLight : "white"
                }
                onValueChange={(value) =>
                  updatePepData({
            ...
            >
              ...
              <Switch
                trackColor={{ false: "#DADADA", true: colors.primary }}
                thumbColor={
                  pep?.isSenGovtOfficial ? colors.primaryLight : "white"
                }
                onValueChange={(value) =>
                  updatePepData({
            ...
            >
              ...
              <Switch
                trackColor={{ false: "#DADADA", true: colors.primary }}
                thumbColor={
                  pep?.isSenJudicialOfficial ? colors.primaryLight : "white"
                }
                onValueChange={(value) =>
                  updatePepData({
            ...
            >
              ...
              <Switch
                trackColor={{ false: "#DADADA", true: colors.primary }}
                thumbColor={
                  pep?.isSenMilitaryOfficial ? colors.primaryLight : "white"
                }
                onValueChange={(value) =>
                  updatePepData({
            ...
            >
              ...
              <Switch
                trackColor={{ false: "#DADADA", true: colors.primary }}
                thumbColor={pep?.isSenExecSOC ? colors.primaryLight : "white"}
                onValueChange={(value) =>
                  updatePepData({
                    isSenExecSOC: value,
                  })
            ...
            >
              ...
              <Switch
                trackColor={{ false: "#DADADA", true: colors.primary }}
                thumbColor={pep?.isImpPPO ? colors.primaryLight : "white"}
                onValueChange={(value) =>
                  updatePepData({
                    isImpPPO: value,
                  })
            ...
            >
              ...
              <Switch
                trackColor={{ false: "#DADADA", true: colors.primary }}
                thumbColor={
                  pep?.isImmediateFamily ? colors.primaryLight : "white"
                }
                onValueChange={(value) =>
                  updatePepData({
            ...
            >
              ...
              <Switch
                trackColor={{ false: "#DADADA", true: colors.primary }}
                thumbColor={
                  pep?.isMemberOfSeniorManagement
                    ? colors.primaryLight
                    : "white"
                }
                onValueChange={(value) =>
            ...
            >
              ...
              <Switch
                trackColor={{ false: "#DADADA", true: colors.primary }}
                thumbColor={pep?.isPepAssociate ? colors.primaryLight : "white"}
                onValueChange={(value) =>
                  updatePepData({
