        ...
        <>
          ...
          >
            ...
            <Switch
              ...
              thumbColor={
                fatca?.isGreenCardHolder ? colors.primaryLight : "white"
              }
              onValueChange={(value) =>
                updateFatcaData({
          ...
          >
            ...
            <Switch
              trackColor={{ false: "#DADADA", true: colors.primary }}
              thumbColor={fatca?.isGranteePOA ? colors.primaryLight : "white"}
              onValueChange={(value) =>
                updateFatcaData({
                  isGranteePOA: value,
                })
          ...
          >
            ...
            <Switch
              trackColor={{ false: "#DADADA", true: colors.primary }}
              thumbColor={
                fatca?.hasStandingInstructIncome ? colors.primaryLight : "white"
              }
              onValueChange={(value) =>
                updateFatcaData({
          ...
          >
            ...
            <Switch
              trackColor={{ false: "#DADADA", true: colors.primary }}
              thumbColor={
                fatca?.isDisclosureTaxResidency ? colors.primaryLight : "white"
              }
              onValueChange={(value) =>
                updateFatcaData({
