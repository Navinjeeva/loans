...
const initialState = {
  ...
  name: "",
  isdCode: "1868",
  isdDescription: "TRINIDAD AND TOBAGO",
  mobileNumber: "",
  email: "",
  loanAmount: "",
  loanTenor: "Months",
  ...
  bankDocuments: [{ id: 1, name: "", doc: [], details: {} }],
  financialDocuments: [{ id: 1, name: "", doc: [], details: {} }],
  ...
  additionalDetails: {
    ...
    spouseLastName: "",
    spouseMobileNumber: "",
    spouseMobileIsdKey: "1868",
    spouseMobileIsdDescription: "TRINIDAD AND TOBAGO",
  },
